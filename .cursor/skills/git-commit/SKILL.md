---
name: git-commit
description: Executa commit semântico com pré-revisão. Use quando o usuário pedir para commitar, fazer commit, dar push, ou revisar e commitar as alterações. Segue Conventional Commits em PT-BR e verifica regras críticas do projeto antes de commitar.
---

# Git Commit — Commit Semântico com Pré-Revisão

Execute o fluxo abaixo quando o usuário pedir para commitar ou fazer push.
