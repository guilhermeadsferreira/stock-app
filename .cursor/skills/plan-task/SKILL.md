---
name: plan-task
description: Planeja a execução de uma task do projeto sem implementar. Use quando o usuário pedir para planejar uma task, fazer o plano de uma task, ou indicar uma task por nome (ex.: historico-de-vendas, barcode). NUNCA implementa durante o planejamento; só executa se o usuário pedir explicitamente depois.
---
