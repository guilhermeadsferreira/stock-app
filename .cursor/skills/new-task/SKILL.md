---
name: new-task
description: Cria uma nova task de projeto em tasks/. Use quando o usuário pedir para criar uma task, nova task, registrar uma tarefa, ou descrever algo a ser feito como task. Gera arquivo em tasks/{nome-da-task}.md com objetivo, contexto, escopo e categoria (feature, refactor, decisão-técnica, auditoria, produto, infra).
---

# New Task — Criar Task de Projeto

Crie uma nova task de projeto com base no contexto fornecido pelo usuário.

---

## 1. Classificar a task

A partir do contexto do usuário, determine a **categoria** da task. Use a tabela abaixo como guia:
